      ...
      <div id="subfooter" style="padding:20px 0px 0px 20px">
        <nav class="row">
		  ...
		  <section id="subfooter-extra" class="small-12 columns credits" style="width:40%;">
			<span><a href="https://plus.feel-kobe.jp/en/" target="_blank"><img src="./assets/img/feel-kobe.jpg" width="45%" /></a>
			  <span><a href="https://kobe-convention.jp/en/" target="_blank"><img src="./assets/img/kobe-convention.jpg" width="45%" /></a>
          </section>
